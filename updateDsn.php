				...
				?>
					...
					?>
						<tr>
							...
							<td><img src="<?php echo "fotodosen/" . $row["foto"] ?>" height="50"></td>
							<td>
								<a class="btn btn-outline-primary btn-sm" href="editDsn.php?kode=<?php echo $row['id'] ?>">Edit</a>
								<a class="btn btn-outline-danger btn-sm" href="hpsDsn.php?kode=<?php echo $row["id"] ?>" id="linkHps" onclick="return confirm('Yakin dihapus nih?')">Delete</a>
							</td>
						</tr>
				<?php
						$no++;
